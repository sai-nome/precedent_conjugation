...
class PDFToVector:
    ...
    def split_text_with_mecab(self, text: str) -> list[str]:
        # MeCabの初期化
        mecab = MeCab.Tagger('')
    ...
    def split_text2vector(self, text: str, max_tokens=6000) -> List[float]:
        vectors = []
    ...
    def convert_text_to_token_ids(self, text: str, filename: str, vector_database: Dict[str, str]) -> Dict[str, str]:
        """
        ...
        vector = self.split_text2vector(text)
